  ...
  return (
    <div className={`bg-white rounded overflow-hidden shadow-xl hover:drop-shadow-xl`}>
      ...
      <div className={`flex p-12 justify-evenly`}>
        ...
        <div className={`w-40 h-40 rounded-full border-2 border-amber-500 relative justify-center items-center text-center mr-6`}>
        <span className={`relative top-12`}>
            <h2 className={`text-5xl`}>0</h2>
        ...
        <div className={`w-40 h-40 rounded-full border-2 border-green-700 relative justify-center items-center text-center`}>
        <span className={`relative top-12`}>
